...
const CardProduct = ({
  ...
  <div className="card-product">
    ...
    <div className="card-product__icon-rate">
      <Icon additionalClass="card-product__start" icon={faStar} />
    ...
    <div className="card-product__download-wrapper">
      ...
      <p className="card-product__downloads">{downloaded}</p>
    </div>
